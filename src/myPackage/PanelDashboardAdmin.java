...
public class PanelDashboardAdmin extends JPanel {
	...
	public PanelDashboardAdmin() {
		...
		panel.setBackground(new Color(122, 102, 10));
		add(panel);
		...
		panel_2.setBackground(new Color(122, 102, 10));
		add(panel_2);
		...
		lblNewLabel_3.setIcon(new ImageIcon(PanelDashboardAdmin.class.getResource("/ExamImages/DashBoardPanelAdmin.jpg")));
